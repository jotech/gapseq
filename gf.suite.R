...
spec <- matrix(c(
  ...
  'min.bs.for.core', 'b', 2, "numeric", "Minimum bitscore for reaction associated blast hits to consider reactions as core/candidate reactions. Default: 50",
...
mseed.t <- mseed.t[id %in% rxn.weights[bitscore > min.bs.for.core, seed]]
...
mod.out.rxns.added.without.seq <- setdiff(gsub("_.0","",mod.out.rxns.added), rxn.weights[bitscore>min.bs.for.core, seed])
