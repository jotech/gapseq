...
media_check <- function(media.file, mod.orig, seed_x_mets){
  ...
  #
  if( length(bm.idx) > 0 ){
    ess.met    <- c("cpd00009", "cpd00012", "cpd00030", "cpd00058", "cpd00034", "cpd10515", "cpd10516","cpd00971","cpd00254", "cpd00205", "cpd00030", "cpd00149", "cpd00099", "cpd00063", "cpd01012", "cpd11574")
    ...
    if( length(missing) > 0 ) warning(paste("Potentially missing copounds in medium:", paste(seed_x_mets[id %in% missing, paste(id, name)], collapse = ", ")))
  }
