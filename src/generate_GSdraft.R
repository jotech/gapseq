...
spec <- matrix(c(
  ...
  'biomass', 'b', 2, "character", "Gram \"pos\" OR \"neg\" OR \"archaea\" OR \"auto\"? Default: \"auto\". Please note: if set to \"auto\", the external programms barrnap, usearch, and bedtools are required.",
