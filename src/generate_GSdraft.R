...
spec <- matrix(c(
  ...
  'sbml.output', 's', 2, "logical", "Should the gapfilled model be saved as sbml? (TRUE/FALSE) Default: TRUE (requires R-package sybilSBML)",
...
if ( is.null(opt$sbml.output) ) { opt$sbml.output = TRUE }
