...
# read target model
cat("Loading model file", mod.file, "\n")
mod.orig <- readRDS(mod.file)

# Get list of core-reactions from one or more files (given as comma separated string by -c)
rxn.weights <- mod.orig@metadata$rxnWeights
rXg.tab     <- mod.orig@metadata$rxnXgenes
