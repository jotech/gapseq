...
spec <- matrix(c(
  ...
  'target.metabolite', 't', 2, "character", "ID (without compartment suffix) of metabolite that shall be produced.\nDefault: cpd11416 (Biomass)",
...
if(!opt$sbml.no.output){
    ...
    write_gapseq_sbml(mod.out, out.id)
}
